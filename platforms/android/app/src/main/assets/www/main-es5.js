...
module.exports = "<ion-menu side=\"start\" menuId=\"first\" contentId=\"mainMenu\">\n  <ion-header>\n    <ion-toolbar color=\"primary\">\n      <ion-title>Start Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content>\n    <ion-list>\n      <ion-menu-toggle *ngFor=\"let item of menuOpts | async\">\n          <ion-item [routerLink]=\"item.redirectTo\" >\n            <ion-icon slot=\"start\" [name]=\"item.icon\"></ion-icon>\n            <ion-label>{{ item.name }}</ion-label>\n          </ion-item>\n      </ion-menu-toggle>\n    </ion-list>\n  </ion-content>\n</ion-menu>"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/components/system/role-form/role-form.component.html":
/*!************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/components/system/role-form/role-form.component.html ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<ion-header translucent>\n  <ion-toolbar>\n    <ion-title>{{ title }}</ion-title>\n    <ion-buttons slot=\"end\">\n      <ion-button (click)=\"dismissModal()\">\n        <ion-icon slot=\"icon-only\" name=\"close\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n<ion-content fullscreen>\n  <form [formGroup]=\"validations_form\"  (ngSubmit)=\"onSubmit(validations_form.value)\">\n    <ion-list lines=\"full\" class=\"ion-no-margin ion-no-padding\">\n      <ion-item>\n        <ion-label position=\"stacked\">Código<ion-text color=\"danger\">*</ion-text></ion-label>\n        <ion-input required type=\"text\" formControlName=\"code\" ></ion-input>\n      </ion-item>\n      <div class=\"validation-errors\">\n        <ng-container *ngFor=\"let validation of validation_messages.code\">\n          <div class=\"error-message\" *ngIf=\"validations_form.get('code').hasError(validation.type) && (validations_form.get('code').dirty || validations_form.get('code').touched)\">\n            {{ validation.message }}\n          </div>\n        </ng-container>\n      </div>\n      <ion-item>\n        <ion-label position=\"stacked\">Nombre<ion-text color=\"danger\">*</ion-text></ion-label>\n        <ion-input required type=\"text\" formControlName=\"name\"></ion-input>\n      </ion-item>\n      <div class=\"validation-errors\">\n        <ng-container *ngFor=\"let validation of validation_messages.name\">\n          <div class=\"error-message\" *ngIf=\"validations_form.get('name').hasError(validation.type) && (validations_form.get('name').dirty || validations_form.get('name').touched)\">\n            {{ validation.message }}\n          </div>\n        </ng-container>\n      </div>\n      <ion-item>\n        <ion-checkbox slot=\"start\" formControlName=\"state\"></ion-checkbox>\n        <ion-label>Estado</ion-label>\n      </ion-item>\n\n    </ion-list>\n    <ion-toolbar class=\"ion-padding\">\n      <ion-button color=\"primary\"  size=\"default\" expand=\"block\" [disabled]=\"!validations_form.valid\" type=\"submit\">\n        <ion-icon slot=\"start\" name=\"checkmark\"></ion-icon>\n        {{ btnText }}\n      </ion-button>\n    </ion-toolbar>\n  </form>\n</ion-content>\n"
...
var routes = [
    {
        path: '',
        loadChildren: function () { return Promise.all(/*! import() | pages-dashboard-dashboard-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./pages/dashboard/dashboard.module */ "./src/app/pages/dashboard/dashboard.module.ts")).then(function (m) { return m.DashboardPageModule; }); },
    ...
    {
        path: 'configurations',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-system-configurations-configurations-module */ "pages-system-configurations-configurations-module").then(__webpack_require__.bind(null, /*! ./pages/system/configurations/configurations.module */ "./src/app/pages/system/configurations/configurations.module.ts")).then(function (m) { return m.ConfigurationsPageModule; }); }
    },
    {
        path: 'personal-information',
        loadChildren: function () { return Promise.all(/*! import() | pages-system-personal-information-personal-information-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-system-personal-information-personal-information-module")]).then(__webpack_require__.bind(null, /*! ./pages/system/personal-information/personal-information.module */ "./src/app/pages/system/personal-information/personal-information.module.ts")).then(function (m) { return m.PersonalInformationPageModule; }); }
    },
    {
        path: 'role',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-system-role-role-module */ "pages-system-role-role-module").then(__webpack_require__.bind(null, /*! ./pages/system/role/role.module */ "./src/app/pages/system/role/role.module.ts")).then(function (m) { return m.RolePageModule; }); }
    }
];
...
/* harmony import */ var _components_system_role_form_role_form_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/system/role-form/role-form.component */ "./src/app/components/system/role-form/role-form.component.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [
                _components_system_role_form_role_form_component__WEBPACK_IMPORTED_MODULE_19__["RoleFormComponent"]
            ],
            imports: [
                ...
                _angular_fire__WEBPACK_IMPORTED_MODULE_16__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].firebase),
...
/* harmony import */ var _system_role_form_role_form_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./system/role-form/role-form.component */ "./src/app/components/system/role-form/role-form.component.ts");
    ...
    ComponentModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _system_role_form_role_form_component__WEBPACK_IMPORTED_MODULE_7__["RoleFormComponent"]
            ],
            exports: [
                _menu_menu_component__WEBPACK_IMPORTED_MODULE_4__["MenuComponent"],
                _header_header_component__WEBPACK_IMPORTED_MODULE_6__["HeaderComponent"],
...
var HeaderComponent = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ], HeaderComponent.prototype, "backIcon", void 0);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_services_api_system_menu_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/api/system/menu.service */ "./src/app/services/api/system/menu.service.ts");
...
var MenuComponent = /** @class */ (function () {
    ...
    MenuComponent.ctorParameters = function () { return [
        { type: src_app_services_api_system_menu_service__WEBPACK_IMPORTED_MODULE_2__["MenuService"] }
    ]; };
    MenuComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_api_system_menu_service__WEBPACK_IMPORTED_MODULE_2__["MenuService"]])
    ], MenuComponent);
...
/***/ "./src/app/components/system/role-form/role-form.component.scss":
/*!**********************************************************************!*\
  !*** ./src/app/components/system/role-form/role-form.component.scss ***!
  \**********************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvc3lzdGVtL3JvbGUtZm9ybS9yb2xlLWZvcm0uY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/components/system/role-form/role-form.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/components/system/role-form/role-form.component.ts ***!
  \********************************************************************/
...
/* harmony import */ var src_app_services_api_system_role_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/api/system/role.service */ "./src/app/services/api/system/role.service.ts");
/* harmony import */ var src_app_services_create_code_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/create-code.service */ "./src/app/services/create-code.service.ts");
...
var RoleFormComponent = /** @class */ (function () {
    function RoleFormComponent(modalCtrl, formBuilder, roleService, createCodeService, alertCtrl, loadingCtrl) {
        ...
        this.validations_form = this.formBuilder.group({
            ...
            state: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](true),
        });
    }
    ...
    RoleFormComponent.prototype.dismissModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalCtrl.dismiss().then(function () { console.log('dismiss modal'); });
                return [2 /*return*/];
            });
        });
    };
    RoleFormComponent.prototype.onSubmit = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (this.key) {
    ...
    RoleFormComponent.prototype.getRole = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.roleService.getRoleById(this.key).valueChanges().subscribe(function (data) {
                    _this.validations_form.setValue({ name: data.name, code: data.code, state: data.state });
                }, function (error2) {
                    console.log(error2);
                });
                return [2 /*return*/];
    ...
    RoleFormComponent.prototype.createRole = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.roleService.createRole(this.role).then(function () {
    ...
    RoleFormComponent.prototype.modifyRole = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.roleService.updateRole(this.role).then(function () {
                            _this.alertCtrl.create({
                                header: 'Enhorabuena',
    ...
    RoleFormComponent.ctorParameters = function () { return [
        ...
        { type: src_app_services_api_system_role_service__WEBPACK_IMPORTED_MODULE_4__["RoleService"] },
        { type: src_app_services_create_code_service__WEBPACK_IMPORTED_MODULE_5__["CreateCodeService"] },
    ...
    ], RoleFormComponent.prototype, "name", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], RoleFormComponent.prototype, "state", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], RoleFormComponent.prototype, "key", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], RoleFormComponent.prototype, "code", void 0);
    RoleFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-role-form',
            template: __webpack_require__(/*! raw-loader!./role-form.component.html */ "./node_modules/raw-loader/index.js!./src/app/components/system/role-form/role-form.component.html"),
            styles: [__webpack_require__(/*! ./role-form.component.scss */ "./src/app/components/system/role-form/role-form.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"],
            src_app_services_api_system_role_service__WEBPACK_IMPORTED_MODULE_4__["RoleService"],
            src_app_services_create_code_service__WEBPACK_IMPORTED_MODULE_5__["CreateCodeService"],
...
var AuthenticationGuard = /** @class */ (function () {
    ...
    AuthenticationGuard.prototype.canActivate = function (next, state) {
        var _this = this;
        return this.authenticationService.getStatus().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (status) {
            if (status) {
                return true;
            }
            else {
    ...
    AuthenticationGuard.prototype.canActivateChild = function (next, state) {
        return true;
    };
...
/***/ "./src/app/services/api/system/menu.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/api/system/menu.service.ts ***!
  \*****************************************************/
...
var MenuService = /** @class */ (function () {
    ...
    MenuService.prototype.getMenuOpts = function () {
...
/***/ "./src/app/services/api/system/role.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/api/system/role.service.ts ***!
  \*****************************************************/
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.loginUser = function (value) {
        return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithEmailAndPassword(value.email, value.password).then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
...
/***/ "./src/app/services/create-code.service.ts":
/*!*************************************************!*\
  !*** ./src/app/services/create-code.service.ts ***!
  \*************************************************/
/*! exports provided: CreateCodeService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateCodeService", function() { return CreateCodeService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var CreateCodeService = /** @class */ (function () {
    function CreateCodeService() {
    }
    CreateCodeService.prototype.getKey = function () {
        var f = new Date();
        return f.getFullYear() + '' + f.getMonth() + '' + f.getDay() + '' + f.getHours() + '' + f.getMinutes() + '' + f.getSeconds() + '' + f.getMilliseconds();
    };
    CreateCodeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCOPEMSkRG7EsyUvBrQeREplurqr8xnhTQ",
        authDomain: "my-tax-1ad49.firebaseapp.com",
        databaseURL: "https://my-tax-1ad49.firebaseio.com",
        projectId: "my-tax-1ad49",
        storageBucket: "my-tax-1ad49.appspot.com",
        messagingSenderId: "539245234932",
        appId: "1:539245234932:web:5f5661ecb8b35834c76ca1",
        measurementId: "G-1612RM8M3Q"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\bitax\src\main.ts */"./src/main.ts");
