...
/***/ "./src/app/services/api/system/user.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/api/system/user.service.ts ***!
  \*****************************************************/
...
/***/ "./src/app/services/components/alert.service.ts":
/*!******************************************************!*\
  !*** ./src/app/services/components/alert.service.ts ***!
  \******************************************************/
...
var AlertService = /** @class */ (function () {
    ...
    AlertService.prototype.presentAlert = function (title, subTitle, msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.alert = _b.sent();
                        return [4 /*yield*/, this.alert.present().then(function () {
                                console.log('presented');
                                if (!_this.isAlert) {
                                    _this.alert.dismiss().then(function () { return console.log('abort presenting'); });
                                }
                            })];
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.isAlert = false;
                        return [4 /*yield*/, this.alert.dismiss().then(function () { return console.log('dismissed'); })];
...
/***/ "./src/app/services/components/loading.service.ts":
/*!********************************************************!*\
  !*** ./src/app/services/components/loading.service.ts ***!
  \********************************************************/
...
var LoadingService = /** @class */ (function () {
    ...
    LoadingService.prototype.showLoading = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
