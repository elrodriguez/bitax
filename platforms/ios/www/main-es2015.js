...
const routes = [
    ...
    {
        path: 'configurations',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-system-configurations-configurations-module */ "pages-system-configurations-configurations-module").then(__webpack_require__.bind(null, /*! ./pages/system/configurations/configurations.module */ "./src/app/pages/system/configurations/configurations.module.ts")).then(m => m.ConfigurationsPageModule)
    },
    {
        path: 'personal-information',
        loadChildren: () => Promise.all(/*! import() | pages-system-personal-information-personal-information-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-system-personal-information-personal-information-module")]).then(__webpack_require__.bind(null, /*! ./pages/system/personal-information/personal-information.module */ "./src/app/pages/system/personal-information/personal-information.module.ts")).then(m => m.PersonalInformationPageModule)
    },
    {
        path: 'role',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-system-role-role-module */ "pages-system-role-role-module").then(__webpack_require__.bind(null, /*! ./pages/system/role/role.module */ "./src/app/pages/system/role/role.module.ts")).then(m => m.RolePageModule)
    }
];
...
let RoleFormComponent = class RoleFormComponent {
    constructor(modalCtrl, formBuilder, roleService, createCodeService, alertCtrl, loadingCtrl) {
    ...
    getRole() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.roleService.getRoleById(this.key).valueChanges().subscribe((data) => {
...
RoleFormComponent.ctorParameters = () => [
...
let AuthenticationGuard = class AuthenticationGuard {
    ...
    canActivate(next, state) {
        return this.authenticationService.getStatus().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(status => {
            if (status) {
                return true;
            }
            else {
...
let CreateCodeService = class CreateCodeService {
    constructor() { }
    getKey() {
        let f = new Date();
